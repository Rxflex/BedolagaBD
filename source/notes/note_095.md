...
- **[639113|Honey Montana|04.06]** Вечером упала половина нод; селфстил, смена fp, транспорта, сни не помогают.
...
- **[642460|Руслан Иванов|05.06]** Новый уровень блокировок: прямое подключение к ру-ноде таймаутит, а редирект на ру-ноду со всех иностранных нод (в т.ч. Казахстан) работает.
...
- **[636040|Ранзай Родионов|04.06]** Проблема, что ios (Happ/v2raytun) сами отключаются, ютуб тормозит — обсуждали, что из-за роутинга (конфиг ниже).
...
- **[640318|Константин Кривоносов|04.06]** Дока ремны: https://docs.rw/docs/awesome-remnawave
...
### VLESS WS + nginx (подарок чата) [647996|Wyatt Haley|07.06] — реально в чанке 096, id 647996 — но сообщение в 095-м диапазоне? — Нет, id 647996 > 644635, это chunk_096. Не сюда.
...
- **[637318|Roman Shuvalov|04.06]** Express Hosting: худший за последнее время в Нидерландах; два ядра Ryzen 9 9950X улетают под 100% от 25 человек; Польша с такими же параметрами всё ок.
...
- **[638877|Sergey Komarov|04.06]** Отсутствие POST у Яндекс CDN — не обойти (Frist: никак [636406]).
...
## Прочее
- **[641881|—|04.06]** Соксы/WG внутри России ещё живут (Sergey Komarov: и WG, и AWG спокойно живут).
- **[641401|—|04.06]** Проверка на бане РКН: https://cheburcheck.ru/ (и chebur.me [644640]).
- **[642128|Дмитрий Гузеев|05.06]** МTPROTO упал у всех (05.06 утро) — за вчера всё пахало.
...
- **[641471|Andrey Petrov|05.06]** Домены: spaceship [650882|veloriia|06.06].
- **[643015|Subnet|05.06]** 1 цент (0.5).
- **[645075|—|05.06]** Скачал «База хостингов с сохранением».

(флуд: срачи вокруг Chara Freedom/Frist о «ноде без рекламы ютуба», скам-истории, ддрары, продажи акков/уников — опущено)
