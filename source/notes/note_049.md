...
- **[id=276169|Super User|17.03.2026](https://t.me/c/2941121338/276169)** Баг бота с Caddy-авторизацией панели (docs.rw caddy-with-custom-path): REMNAWAVE_AUTH_TYPE=caddy + CADDY_TOKEN из 2FA → 401; в коде бота Authorization/X-Api-Key перепутаны местами (починено в 3.33.0).
