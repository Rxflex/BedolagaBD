...
- **[647523|Pavel Kosyakov|06.06]** Роскомвпн-список можно в шаблон xray; ссылка не подтягивается в JSON-клиенты.
...
- **[648525|Руслан Иванов|06.06]** Озон начал детектить VPN; фикс — рулинг в direct для доменов озона:
  ```json
...
### VLESS WS + nginx (masquerade «decoy») [651979|Wyatt Haley|07.06]
```json
{
  ...
  "inbounds": [
    {
      ...
      "streamSettings": {
        ...
        "realitySettings": {
          ...
          "shortIds": [""],
          "privateKey": "PJiLkkaJOvlaQ9yeyGJ6pl7a0ngoTCEjpxSATypFZ20",
...
- **[646068|Nikita Morozov|06.06]** Обновление бота: `git pull && make reload`.
...
- **[644837|Леш Лешич|05.06]** Каждые 5–6 минут обрыв (fp firefox, h3 alpn, selfsteal); причина не в fp; похоже на баг балансира (obs: Happ-логи ругаются на ошибку пинга из burst-observatory) [645016].
...
- **[647695|Pavel Kosyakov|06.06]** Перейдите на grpc; xhttp не особо рекомендую, но на запас можно.
...
- **[652993|Stanislav Torichnev|07.06]** В dev-ветке хаппа проблем с xhttp нет; сидит 16 часов на XHTTP Reality Auto на iOS.
...
- **[650338|Nikita Morozov|07.06]** Cloudrux (Spain): awg.
...
## Платежки
- **[648007|—|07.06]** Платега (Platega): взлом менеджера, аккаунт заморожен, вебхуки не прилетают [649376|Ак Барс|06.06], платежи «ожидает оплаты», зачислений нет; ТП работает 9–21 Мск.
