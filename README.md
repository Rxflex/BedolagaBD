...
Каждый факт снабжён пруфом: `[id=698034|YukiOff1cial|16.06.2026]` — номер сообщения в экспорте чата, автор, дата.

- Нужен исходный текст сообщения → [source/README.md](source/README.md): по диапазону id находите заметку, в ней тот же `[id=...]` рядом с дословной цитатой.
...
indexes/
  ...
  ссылки.md            — 305 внешних ссылок                    (генерится)
...
_tools/                — генераторы навигации, индексов и графики
```
